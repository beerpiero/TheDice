<?php
	...
	$token = "fFzcNjFT+jDVGe+uh+bEU38+NiOGvuRdzT8DtQpZCDnzHvRCq1//YTdUMq7sf0JTdtXWqB9Jb4wcD8d++ETl4gOvlny0risBHITmVZZASVl/V/2VLnV80qT+3JMPEYC8q+tOxg0vkVWRrfttR4+kKAdB04t89/1O/w1cDnyilFU=";
    ...
    $client->setAuthConfig(__DIR__.'/thedice-a305e378834c.json');
    $client->setAccessType('offline');
    // $client->setPrompt('select_account consent');

    $service = new \Google_Service_Sheets($client);

    $spreadsheetId = "1oN5Yl2pTXXv7WzY4YPzezsbpsjsg_Hna3JnoLjkmweg";
